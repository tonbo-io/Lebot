...
def main():
    parser = argparse.ArgumentParser(description="Analyze Linear issues grouped by project and initiative.")
    parser.add_argument("--team-id", help="Optional: filter by team ID")
    parser.add_argument("--include-completed", action="store_true", help="Include completed and canceled issues")
